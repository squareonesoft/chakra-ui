...
var createSerializer = require("./create-serializer-a9846073.cjs.prod.js"), enzymeToJson = require("enzyme-to-json"), enzymeSerializer = enzymeToJson.createSerializer({}), tickle = function(wrapper) {
  return "function" == typeof wrapper.dive && wrapper.find("EmotionCssPropInternal").forEach((function(el) {
    return el.dive();
  })), wrapper;
};
