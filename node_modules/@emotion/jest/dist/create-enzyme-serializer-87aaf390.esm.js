import { c as createSerializer$1 } from './create-serializer-31b41345.esm.js';
  ...
  return {
    ...
    serialize: function serialize(node, config, indentation, depth, refs, printer) {
      if (enzymeSerializer.test(node)) {
        ...
        return enzymeSerializer.print(tickled, // https://github.com/facebook/jest/blob/470ef2d29c576d6a10de344ec25d5a855f02d519/packages/pretty-format/src/index.ts#L281
        function (valChild) {
