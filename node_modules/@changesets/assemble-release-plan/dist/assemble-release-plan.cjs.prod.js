  ...
  for (;pkgsToSearch.length > 0; ) {
    ...
    pkgDependents.map((dependent => {
      ...
      if (ignoredPackages.includes(dependent)) type = "none"; else {
        ...
        })) type = "major"; else if (!(releases.has(dependent) && "none" !== releases.get(dependent).type || semver__default.default.satisfies(incrementVersion(nextRelease, preInfo), versionRange))) switch (depType) {
         case "dependencies":
