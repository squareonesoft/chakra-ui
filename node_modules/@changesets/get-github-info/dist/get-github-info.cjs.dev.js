...
const GHDataLoader = new DataLoader(async requests => {
  if (!process.env.GITHUB_TOKEN) {
    throw new Error("Please create a GitHub personal access token at https://github.com/settings/tokens/new and add it as the GITHUB_TOKEN environment variable");
  }
  ...
  }).then(x => x.json()); // this is mainly for the case where there's an authentication problem
